...
$peso=$_POST['peso'];
    ...
    $consulta="insert into bebidas (nombre, precio_actual, precio_anterior,total_invertido,kgLts) values ('".$nombre."', '".$actualPrecio."', '".$anteriorPrecio."', '".$totalInvertido."','".$peso."')";
...
if($query){
    ...
    echo ("<script>location.href='agregar_bebida.php'</script>");
};
