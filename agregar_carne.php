...
$consulta="insert into carnes (nombre, precio_actual, precio_anterior,total_invertido,kgLts) values ('".$nombre."', '".$actualPrecio."', '".$anteriorPrecio."', '".$totalInvertido."','".$peso."')";
...
if($query){
    ...
    echo ("<script>location.href='agregar_carne.php'</script>");
};
