...
$consulta="select * from cereales_leguminosas";
    ...
    <body>
                ...
                <section class="col-xs-12 col-sm-6 col-md-12 margen-abajo">
                 ...
                 <section class="col-xs-12 col-sm-6 col-md-6 margen-abajo">
                    <div class="text-right">
                        <a href="agregarCereales.php"><button class="btn btn-success">Agregar</button></a>
                    </div>
        ...
        <script>
            ...
            $(".editar").click(function(){
                ...
                window.location="editar_cereales.php?id="+id;
            });
            ...
            $(".borrar").click(function(){
                ...
                {
                    var id=$(this).attr("iduser");
                    window.location="borrar_cereales.php?id="+id;
                }
