...
$consulta="select * from carnes_frias";
    ...
    <body>
            ...
            <section class="row">
                ...
                <section class="col-xs-12 col-sm-6 col-md-6 margen-abajo">
                    <div class="text-right">
                        <a href="agregarFrias.php"><button class="btn btn-success">Agregar</button></a>
                    </div>
        ...
        <script>
            ...
            $(".editar").click(function(){
                ...
                window.location="editar_frias.php?id="+id;
            });
            ...
            $(".borrar").click(function(){
                ...
                {
                    var id=$(this).attr("iduser");
                    window.location="borrar_frias.php?id="+id;
                }
