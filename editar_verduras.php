...
$verduras="select * from verduras where id=".$id;

$query=$bd->prepare($verduras);
$query->execute();
        ...
        <section class="container">
            <section class="row">
                <section class="col-xs-12 col-sm-6 col-md-12">
                    <form class="col-md-4 col-md-offset-4" action="edicion_realizada_verduas.php" method="post">
